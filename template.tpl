...
[
  {
    ...
    "help": "Type the 8 character domain code available in the CookieHub dashboard (Domain overview). If you havenu0027t created your CookieHub account yet, you can register on cookiehub.com"
  },
  {
    "type": "SELECT",
    "name": "language",
